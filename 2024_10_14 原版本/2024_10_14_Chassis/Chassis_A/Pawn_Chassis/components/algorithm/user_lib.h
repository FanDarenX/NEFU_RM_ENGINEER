...
//一阶滤波(速度斜坡)计算
extern void first_order_filter_speed_ramp_cali(first_order_filter_type_t *first_order_filter_type, fp32 input);
//一阶滤波计算
extern void first_order_filter_cali(first_order_filter_type_t *first_order_filter_type, fp32 input);
//绝对限制
extern void abs_limit(float *num, fp32 Limit);
//判断符号位
...
extern fp32 fast_pow(double x, int n)  ;
extern fp32 atan_tl(fp32 dy);
//弧度格式化为-PI~PI
