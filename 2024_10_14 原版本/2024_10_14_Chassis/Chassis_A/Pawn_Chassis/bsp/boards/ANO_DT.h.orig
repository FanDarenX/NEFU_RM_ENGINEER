...
extern pid_param_type pid_param[18];
extern unsigned char cmd_buff[17];

extern short waveform[20];                      //波形缓存
extern unsigned char data_to_send[100];         //发送数据缓存
extern unsigned char data_to_receive[100];      //接收的缓存
extern unsigned char WAVEFORM_DISABLE;
extern unsigned char WAVESHOW_FLAG;

//fun
void ANO_DT_Send_Data(unsigned char *dataToSend , uint32_t length);
