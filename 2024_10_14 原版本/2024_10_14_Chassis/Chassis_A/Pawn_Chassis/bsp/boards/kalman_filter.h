...
#define mat              arm_matrix_instance_f32//声明矩阵结构体
#define Matrix_Init      arm_mat_init_f32//初始化矩阵
#define Matrix_Add       arm_mat_add_f32//加
#define Matrix_Subtract  arm_mat_sub_f32//减
#define Matrix_Multiply  arm_mat_mult_f32//乘
#define Matrix_Transpose arm_mat_trans_f32  //转置
#define Matrix_Scale     arm_mat_scale_f32//数乘
#define Matrix_Inverse   arm_mat_inverse_f32//逆矩阵
