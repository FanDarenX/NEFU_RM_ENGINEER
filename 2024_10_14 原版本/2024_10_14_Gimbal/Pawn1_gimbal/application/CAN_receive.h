...
typedef enum
{
	CAN_SEND_TO_CAP_ID = 0X307,
		CAN_GET_CAP_ID = 0X309,
    ...
    CAN_3508_M4_ID = 0x204,
		...
		CAN_CANNON_ALL_ID = 0x1FF,
    CAN_FIRE1_MOTOR_ID = 0x201,
    CAN_FIRE2_MOTOR_ID = 0x202,
    CAN_TRIGGER_MOTOR_ID = 0x203,
	  CAN_BARR_MOTOR_ID = 0x207,
...
extern void CAN_cmd_cannon(int16_t shoot, int16_t pitch,int16_t fire1, int16_t fire2);
extern void CAN_cmd_cap_flag(int16_t X_speed, //速度
	int8_t Y_speed, //速度
	int8_t remake_flag,
