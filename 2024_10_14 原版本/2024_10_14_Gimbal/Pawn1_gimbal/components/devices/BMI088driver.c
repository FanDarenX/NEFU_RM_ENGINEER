...
void Calibrate_MPU_Offset(IMU_Data_t *bmi088)
{
    ...
    float gNormTemp, gNormMax, gNormMin;
		int16_t GyroOffset0,GyroOffset1,GyroOffset2;
...
//		GyroOffset0 =(int16_t)(bmi088->GyroOffset[0]*1000000);//10的6次方
//		GyroOffset1 =(int16_t)(bmi088->GyroOffset[1]*1000000);//10的6次方
//		GyroOffset2 =(int16_t)(bmi088->GyroOffset[2]*1000000);//10的6次方
//		
//		gyro_off_write_data[0]=GyroOffset0>>8;
//		gyro_off_write_data[1]=GyroOffset0;
//		gyro_off_write_data[2]=GyroOffset1>>8;
//		gyro_off_write_data[3]=GyroOffset1;
//		gyro_off_write_data[4]=GyroOffset2>>8;
//		gyro_off_write_data[5]=GyroOffset2;
//		//擦除flash页
