...
void ui_scan_and_send(const ui_interface_figure_t *ui_now_figures, \
	uint8_t *ui_dirty_figure, const ui_interface_string_t *ui_now_strings, \
		uint8_t *ui_dirty_string, int total_figures, int total_strings);
